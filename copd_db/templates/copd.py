...
def _num_to_pretty_str(x):
    #
    # 9/17/09 --  workaround for (bizarre) casting issue
    # here where x is passed in as a unicode string. This
    # does not happen on the local build, where the numbers
    # are stored as Decimal instances. I'm not sure what causes
    # the discrepancy.
